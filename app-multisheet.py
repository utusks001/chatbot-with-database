...
with st.sidebar:
    ...
    # Ambil GOOGLE_API_KEY dari berbagai sumber
    GOOGLE_API_KEY = (
    ...
    # Kalau kosong, user input manual
    ...
    if st.button("💾 Simpan API Key"):
        if api_key_input.strip():
            ...
            if IS_STREAMLIT_CLOUD:
                st.info("☁️ Jalankan di Streamlit Cloud → Gunakan *Settings → Secrets* untuk menyimpan permanen.")
            else:
                try:
